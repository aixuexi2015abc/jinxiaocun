...
Public.ajax = function(ajaxOpts){    
	var opts = {
	   ...
	   timeout :10000,
	   error: function(err){  
			parent.Public.tips({type: 1, content : '服务端响应错误111！您可能没有权限操作此功能。'});
	   }
	};
...
Public.ajaxPost = function(url, params, callback, errCallback){    
	$.ajax({  
	   ...
	   error: function(err,ms){  
			parent.Public.tips({type: 1, content : '服务端响应错误222！您可能没有权限操作此功能。'});
...
$.fn.extend({
	...
	ajaxPost:function(url, params, callback, errCallback){
		...
		var ajaxOpts = {  
		   ...
		   error: function(err){  
				parent.Public.tips({type: 1, content : '服务端响应错误333！您可能没有权限操作此功能。'});
				errCallback && errCallback(err);
		   }  
		}
...
Public.ajaxGet = function(url, params, callback, errCallback){    
	$.ajax({  
	   ...
	   error: function(err){  
			// parent.Public.tips({type: 1, content : '服务端响应错误444！您可能没有权限操作此功能。'});
			// errCallback && errCallback(err);
	   }  
	});  
};
