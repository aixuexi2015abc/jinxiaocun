...
var THISPAGE = {
	...
	addEvent: function() {
		...
		$("#search").click(function() {
			queryConditions.matchCon = "输入单据号/客户名/备注查询" === a.$_matchCon.val() ? "" : a.$_matchCon.val(), queryConditions.beginDate = a.$_beginDate.val(), queryConditions.endDate = a.$_endDate.val(), THISPAGE.reloadData(queryConditions)
