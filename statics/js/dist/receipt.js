...
var THISPAGE = {
	...
	//<a href="../scm/receipt/toPdf?action=toPdf" target="_blank" id="print" class="ui-btn mrb">打印</a>
	initDom: function(a) {
		...
		var b = '<a id="savaAndAdd" class="ui-btn ui-btn-sp mrb">保存并新增</a><a id="save" class="ui-btn">保存</a>',
			...
			f = "",
			g = "";
		billRequiredCheck ? (e = '<a class="ui-btn" id="audit">审核</a>', f = '<a class="ui-btn" id="reAudit">取消审核</a>') : this.$_checkName.parent().hide();
