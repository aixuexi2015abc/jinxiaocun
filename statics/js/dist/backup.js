...
function recoverConfirm(a) {
	var b = ["<p>您将把本系统数据恢复到备份文件所在的状态，<strong>此操作不可逆</strong>，请谨慎操作。</p>", "<p>为保证备份数据的完整性，<strong>请确保其他用户已经退出系统</strong>。</p>", "<p>确定恢复备份？</p>"];
	$.dialog({
		title: "恢复备份",
		width: 340,
		height: 120,
...
function recoverBackup(a) {
	...
	$.ajax({
		...
		success: function(a) {
			...
			(parent.window.$.cookie("ReloadTips", "恢复备份成功！"), parent.window.location.reload())//add by xufangli 20210723 for 修复恢复
