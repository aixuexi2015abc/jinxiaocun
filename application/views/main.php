  ...
  <div class="col-main">
    <div class="main-wrap cf">
	  ...
	  <li class="purchase-purchase">
        	<a tabid="purchase-purchase" data-right="PU_ADD" tabTxt="销售单" parentOpen="true" rel="pageTab" href="<?php echo site_url('scm/invSa?action=initSale')?>"><span></span>销售单</a>
        </li>
        <li class="purchase-purchase">
        ...
        <li class="storage-otherWarehouse">
        	<a tabid="storage-otherWarehouse" data-right="IO_ADD" tabTxt="客户信息" parentOpen="true" rel="pageTab" href="<?php echo site_url('settings/customer_list')?>"><span></span>客户信息</a>
        </li>
        <li class="storage-otherWarehouse">
        	<a tabid="storage-otherWarehouse" data-right="IO_ADD" tabTxt="供应商信息" parentOpen="true" rel="pageTab" href="<?php echo site_url('settings/vendor_list')?>"><span></span>供应商信息</a>
        </li>
        <li class="storage-otherWarehouse">
        	<a tabid="storage-otherWarehouse" data-right="IO_ADD" tabTxt="商品信息" parentOpen="true" rel="pageTab" href="<?php echo site_url('settings/goods_list')?>"><span></span>商品信息</a>
        </li>
        <li class="storage-otherWarehouse">
        	<a tabid="storage-otherWarehouse" data-right="IO_ADD" tabTxt="仓库信息" parentOpen="true" rel="pageTab" href="<?php echo site_url('settings/storage_list')?>"><span></span>仓库信息</a>
        </li>
      </ul>
    </div>
  </div>
