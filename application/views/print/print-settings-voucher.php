...
<div class="print-settings-wrap">
  ...
  <div class="settings-ctn" id="printSettings">
      <div class="item">
        <p class="print-tips">为了保证您的正常打印，请先确认您的电脑是否已安装<a href="http://dl.pconline.com.cn/html_2/1/81/id=1322&pn=0&linkPage=1.html" target="_blank">Adobe PDF阅读器</a></p>
      ...
      <div class="item taoda-settings" id="taodaSettings" style="display:none;">
        <p class="print-tips" id="taodaTips">为了保证您的正常打印，请先确认您的电脑是否已安装<a href="/noteprinttemp.do?action=downloadTemplateReader" target="_blank"></a></p>
...
<script>
 (function($){
    ...
    function tadaoPrint(){
      if (parent.parent.SYSTEM.serviceType == 8) {
    	parent.parent.Public.tips({type: 1,content: '该功能暂未上线。'});
        return ;
      }
