...
<div class="wrapper">
  <div class="mod-search cf">
    <div class="fl">
      <ul class="ul-inline">
        <li>
          <input type="text" id="matchCon" class="ui-input ui-input-ph" value="输入单据号/客户名/备注查询">
        </li>
        <li>
          <label>日期:</label>
	...
	<div class="fr">
      ...
      <!-- <a class="ui-btn dn" id="audit">审核</a><a class="ui-btn" id="reAudit">取消审核</a> -->
      <div class="ui-btn-menu">
          ...
          <div class="con more-operate-con" style="margin-left: 0px;font-size: 14px;width: 55px;padding: 6px;">
            <ul class="more-operate cf" style="border-style:dashed; border-width:1px; border-color:#ccc;">
              <li><a href="#" id="reAudit">取消审核</a></li>
            </ul>
          </div>
      </div>
    </div>
...
<script src="<?php echo base_url()?>statics/js/dist/purchaseList.js"></script>
</body>
</html>
