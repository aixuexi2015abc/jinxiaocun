	...
	<div class="mod-search cf">
	    <div class="fl">
	      <ul class="ul-inline">
	        ...
	        <li>
	          <input type="text" id="matchCon" class="ui-input ui-input-ph matchCon" value="按供应商编号/供应商名称/电话等查询">
	        </li>
...
<script src="<?php echo base_url()?>statics/js/dist/vendorList.js"></script>
</body>
</html>