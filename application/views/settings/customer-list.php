	...
	<div class="mod-search cf">
	    <div class="fl">
	      <ul class="ul-inline">
	        ...
	        <li>
	          <input type="text" id="matchCon" class="ui-input ui-input-ph matchCon" value="输入客户编号/ 名称/ 电话查询">
	        </li>
...
<script src="<?php echo base_url()?>statics/js/dist/customerList.js"></script>
</body>
</html>
