    	...
    	<form id="manage-form" action="">
    		<ul class="mod-form-rows base-form" id="base-form">
    			<li class="row-item odd">
    				...
    				<div class="ctn-wrap"><input type="text" value="" class="ui-input" name="number" id="number" maxlength="20"></div>
    			</li>
    			<li class="row-item">
    				<div class="label-wrap"><label for="name">客户名称</label></div>
    				<div class="ctn-wrap"><input type="text" value="" class="ui-input" name="name" id="name" maxlength="20"></div>
    			</li>
    		...
    		<ul class="mod-form-rows">
    			<li class="row-item pb0">
    				...
    				<div class="ctn-wrap"><textarea name="" id="note" class="ui-input ui-input-ph" maxlength="200">添加备注信息</textarea></div>
    			</li>
    		</ul>
    	</form>
    </div>
...
<script src="<?php echo base_url()?>statics/js/dist/customerManage.js"></script>
</body>
</html>