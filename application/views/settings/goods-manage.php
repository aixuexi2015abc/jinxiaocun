...
<div id="tabContent">
    ...
    <div class="manage-wrapper">
        ...
        <div id="initCombo" class="dn">
          <input type="text" class="textbox storageAuto" name="storage" autocomplete="off"> 根据属性设置
    ...
    <div class="manage-wrapper dn">
        <div id="manage-wrap" class="manage-wrap">
            <div class="cf">
                <!-- <h3>库存预警</h3> --><label id='warning'><input type="checkbox">启用分仓预警</label><div style="display:none;"><label id='warningSku' class="dn" ><input type="checkbox">根据属性设置</label></div>
                <ul class="mod-form-rows base-form cf">
                    <li class="row-item">
...
<script src="<?php echo base_url()?>statics/js/dist/goodsManage.js"></script>
