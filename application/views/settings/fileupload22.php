...
<script type="text/javascript" src="<?php echo base_url()?>statics/lib/webuploader/js/jquery.js"></script>
<script type="text/javascript" src="<?php echo base_url()?>statics/lib/webuploader/js/base.js"></script>
<!--<script type="text/javascript" src="<?php echo base_url()?>statics/lib/webuploader/js/upload.js"></script>-->
<script src="<?php echo base_url()?>statics/js/common/plugins/fileupload/js/vendor/jquery.ui.widget.js"></script>
<script src="<?php echo base_url()?>statics/js/common/plugins/fileupload/js/jquery.iframe-transport.js"></script>
<script>
(function( $ ){
