...
<head>
	...
	<script src="<?php echo base_url()?>statics/resources/v7/js/phone_validate.js"></script>
<style>
...
.mod-form li label{margin-bottom:5px;float:left; width:80px;height:32px; line-height:32px;font-family:微软雅黑;font-weight:normal;}
...
#success p{line-height:24px;font-family:微软雅黑;}
</style>
</head>
<body>
<div class="wrapper">
