...
class Common_model extends CI_Model {
	...
	public function checkpurview($id=0) { 
		...
		if ($id>0) {
			...
			die('<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/><div style="text-align:center;"><div style="margin:50px 0px 20px 0px;"><img src="/statics/images/nopower.png" style="width:200px"/></div><div style="color:#808080;">对不起，您没有此页面的操作权限。</div></div>');	
		}
	}
